...
public class NoSlowDown extends Module
{
    ...
    public NoSlowDown() {
        ...
        this.webHorizontalFactor = (Setting<Double>)this.register(new Setting("WebSpeed", (T)2.0, (T)0.0, (T)10.0));
        this.webVerticalFactor = (Setting<Double>)this.register(new Setting("WebSpeed", (T)2.0, (T)0.0, (T)10.0));
        this.setInstance();
    }
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue() && NoSlowDown.mc.player.isInWeb) {
            if (NoSlowDown.mc.player.moveForward != 0.0f || NoSlowDown.mc.player.moveStrafing != 0.0f) {
            ...
            if (NoSlowDown.mc.player.moveVertical != 0.0f) {
