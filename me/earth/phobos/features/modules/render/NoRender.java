...
public class NoRender extends Module
{
    ...
    public void onUpdate() {
        if (this.items.getValue()) {
            ...
            Objects.requireNonNull(EntityItem.class);
            final Stream filter = stream.filter(EntityItem.class::isInstance);
            Objects.requireNonNull(EntityItem.class);
            filter.map(EntityItem.class::cast).forEach(Entity::func_70106_y);
        }
