...
public class OffscreenESP extends Module
{
    ...
    public OffscreenESP() {
        ...
        this.offscreenOnly = (Setting<Boolean>)this.register(new Setting("Offscreen-Only", (T)true));
        ...
        this.fadeDistance = (Setting<Integer>)this.register(new Setting("Fade-Distance", (T)100, (T)10, (T)200));
        this.radius = (Setting<Integer>)this.register(new Setting("Radius", (T)45, (T)10, (T)200));
    ...
    private boolean isValid(final EntityPlayer entity) {
        return entity != OffscreenESP.mc.player && (!entity.isInvisible() || this.invisibles.getValue()) && entity.isEntityAlive();
    }
