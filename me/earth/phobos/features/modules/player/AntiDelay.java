...
public class AntiDelay extends Module
{
    ...
    public AntiDelay() {
        ...
        this.mode = (Setting<Mode>)this.register(new Setting("Mode", (T)Mode.SWORDCRYSTAL));
        this.swordSlotSet = (Setting<Integer>)this.register(new Setting("SwordSlot", (T)5, (T)1, (T)9));
        this.crystaSlotSet = (Setting<Integer>)this.register(new Setting("CrystalSlot", (T)1, (T)1, (T)9));
